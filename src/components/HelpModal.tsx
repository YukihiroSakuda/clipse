...
const SECTIONS = [
  ...
  },
  {
    ...
    rows: [
      { keys: ['F1'], desc: 'Arrow' },
      { keys: ['F2'], desc: 'Line' },
      { keys: ['F3'], desc: 'Rectangle' },
      { keys: ['F4'], desc: 'Ellipse' },
      { keys: ['F5'], desc: 'Text' },
      { keys: ['F6'], desc: 'Number marker' },
      { keys: ['F7'], desc: 'Highlight' },
      { keys: ['F8'], desc: 'Blur / redact' },
      { keys: ['F9'], desc: 'Spotlight' },
      { keys: ['F10'], desc: 'Crop' },
      { keys: ['F11'], desc: 'Select' },
      { keys: ['F12'], desc: 'Hand (drag to pan)' },
    ],
  },
  {
